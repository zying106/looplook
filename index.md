...
loop topologies. Reclassification rules (minimum input H3K4me1 +
H3K4me3): P + dual marks → `dual`; P + enhancer marks → `E`; eP/eG +
promoter marks → `P`/`G` (revert); E + H3K4me3 only → `P` (unannotated
promoter); and more. Supports `recompute_targets = TRUE` to rebuild
