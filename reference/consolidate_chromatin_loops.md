...
#> Finished! Saved to /tmp/RtmpQXiS7z/file22c63614e8f7.bedpe
...
#> Finished! Saved to /tmp/RtmpQXiS7z/file22c6622afbf7.bedpe
...
#> Finished! Saved to /tmp/RtmpQXiS7z/file22c63165d787.bedpe
...
#> >>> Clustering mode (Union/Consensus): Merging coordinates via Graph
#> >>> Consensus mode: Keeping clusters in >= 2 replicates
#> Finished! Saved to /tmp/RtmpQXiS7z/file22c67b0a207.bedpe
