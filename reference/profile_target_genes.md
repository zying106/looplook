...
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_A_Integrative_loops_EP_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_A_Integrative_loops_EP_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
#> --- Task: PP_Genes (Valid Genes: 124) ---
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_A_Integrative_loops_PP_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_A_Integrative_loops_PP_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
#> ================================================================
...
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_A_Integrative_targets_Target_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_A_Integrative_targets_Target_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
...
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_B_PromoterOnly_Promoter_targets_Target_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_B_PromoterOnly_Promoter_targets_Target_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
#>  All analysis complete.
...
#> 
#> --- Task: EP_Genes (Valid Genes: 36) ---
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_C_StrictLoops_loops_EP_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_C_StrictLoops_loops_EP_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
#> --- Task: PP_Genes (Valid Genes: 124) ---
#>     Saved LFC Violin Plot: /tmp/RtmpLFv4cM/Scenario_C_StrictLoops_loops_PP_Genes_LFC_Violin.pdf
#>     Saved GSEA Plot (Custom): /tmp/RtmpLFv4cM/Scenario_C_StrictLoops_loops_PP_Genes_GSEA.pdf
#>     [Extra Analysis] Found 'n_Linked_Distal'. Running distal connectivity analysis...
#> 
#>  All analysis complete.
```
